...
위치 기반으로 **지금 운영 중인 약국**을 지도와 거리순 목록으로 보여주는 웹 서비스. **[라이브 데모](https://find-pharmacy-puce.vercel.app/)**
...
| **보안** | 배포 직후 Next.js의 심각한 원격 코드 실행 취약점(CVE-2025-66478, CVSS 10.0)을 발견해 즉시 패치 |
