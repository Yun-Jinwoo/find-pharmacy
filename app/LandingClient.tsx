...
export default function LandingClient() {
  ...
  useEffect(() => {
    ...
    function setStep(n: number) {
      ...
      steps.forEach((s) =>
        s.classList.toggle("on", s.getAttribute("data-go") === String(n)),
      );
      const scanning = n === 1;
    ...
    const stio = new IntersectionObserver(
      (es) => {
        es.forEach((e) => {
          if (e.isIntersecting)
            setStep(+(e.target.getAttribute("data-go") ?? 1));
        });
      },
      { threshold: 0.55 },
    );
  ...
  return (
    <div className="lp" ref={rootRef}>
      {/* ================================================================ HERO */}
      <section
        className="hero relative flex min-h-svh flex-col overflow-hidden bg-[#0C2A33] text-white"
        id="hero"
      >
        <div
          className="hero-map absolute inset-0 overflow-hidden"
          aria-hidden="true"
        >
          {/* 밤 지도 : 블록 + 도로 */}
          ...
          <div
            className="pin g"
            style={{ left: "58%", top: "26%", "--pd": ".9s" } as CSSVars}
          >
        ...
        <div
          className={`${WRAP} relative z-[5] mt-auto w-full pb-[max(13vh,104px)]`}
        >
          <span className="clock-chip inline-flex items-center gap-2 rounded-full border border-[rgba(34,211,238,.3)] bg-[rgba(14,42,51,.72)] px-[15px] py-2 text-[13.5px] font-bold text-[#cfeef5] backdrop-blur-[6px]">
            <span className="dot" />
            지금{" "}
            <b className="text-[14.5px] text-white tabular-nums" id="liveClock">
              밤 9:41
            </b>{" "}
            · 운영 중인 약국만 표시
          </span>
          ...
          <p className="sub max-w-[34em] text-[clamp(15px,2.2vw,17.5px)] font-medium text-[rgba(223,240,244,.82)]">
            밤 11시에도, 연휴 한복판에도. 현재 위치에서 지금 운영 중인 약국을
            지도에서 바로 확인하세요.
          </p>
          <div className="hero-cta mt-[26px] flex flex-wrap gap-[11px]">
            <Link
              className={`${BTN} ${BTN_PRIMARY} px-[26px] py-[15px] text-[15.5px]`}
              href="/map"
            >
              <svg
                width="17"
      ...
      {/* ================================================================ 문제 제기 */}
      <section
        className="problem relative bg-[linear-gradient(to_bottom,#081c23,#0C2A33_30%,#0C2A33)] pt-[110px] pb-[120px] text-white"
        id="problem"
      >
        <div
          className={`${WRAP} grid items-center gap-12 min-[880px]:grid-cols-[1.05fr_.95fr] min-[880px]:gap-16`}
        >
          <div>
            ...
            >
              &lsquo;약국&rsquo;을 검색하면{" "}
              <span className="text-[#22D3EE] tabular-nums">42곳</span>.
              <br />그 중 지금 문 연곳은 어디?
            </h2>
            <p
              className="max-w-[32em] text-[16px] text-[rgba(214,233,238,.78)]"
              data-reveal
              style={{ "--d": ".16s" } as CSSVars}
            >
              아이 열이 오르는 밤, 지도 앱은 약국을 수십 곳 보여주지만{" "}
              <b className="text-white">이 시간에 문을 연 곳</b>이 어딘지는
              알려주지 않아요.
            </p>
            <div
          ...
          >
            <header className="mb-[14px] flex items-center justify-between text-[13px] font-bold text-[rgba(255,255,255,.6)]">
              ...
              <span>
                <span className="text-white tabular-nums" id="dyingCount">
                  5
                </span>
                곳 남음
              </span>
            ...
            <div className="d-card mb-[9px] flex items-center gap-[10px] rounded-[15px] bg-white px-[15px] py-[13px] text-[#0E2A33] last:mb-0">
              <span className="text-[14.5px] font-bold tracking-[-.3px]">
                늘푸른약국
              </span>
              <Badge status="closing">확인 중</Badge>
              <span className="hours ml-auto text-[12.5px] font-semibold text-[#5E7C88]">
                신호 감&hellip;
              </span>
            </div>
            <div className="d-card mb-[9px] flex items-center gap-[10px] rounded-[15px] bg-white px-[15px] py-[13px] text-[#0E2A33] last:mb-0">
            ...
            <div className="d-card found mb-[9px] flex items-center gap-[10px] rounded-[15px] bg-white px-[15px] py-[13px] text-[#0E2A33] last:mb-0">
              ...
              <span className="text-[14px] font-extrabold text-[#086B82] tabular-nums">
                320m · 밤 12시까지
              </span>
            </div>
          </div>
      ...
      >
        <div className={WRAP}>
          <div className="mb-[52px] max-w-[620px]">
            ...
            <p
              className="text-[16px] text-[#5E7C88]"
              data-reveal
              style={{ "--d": ".16s" } as CSSVars}
            >
          ...
          <div className="grid gap-[18px] min-[700px]:grid-cols-2">
            ...
            >
              <div
                className="f-stage stage-map relative mb-1 h-[172px] overflow-hidden rounded-xl bg-[#0C2A33]"
                data-stage="map"
              >
                <svg
              ...
              <div
                className="grid h-11 w-11 place-items-center rounded-[13px] bg-[rgba(11,143,172,.1)] text-[#0B8FAC]"
                aria-hidden="true"
              >
                <svg
                  width="21"
              ...
              <h3 className="mt-[18px] mb-2 text-[19px] font-extrabold tracking-[-.4px]">
                지도에서 운영 상태가 색으로
              </h3>
              <p className="text-[14.5px] leading-[1.65] text-[#5E7C88]">
                초록은 운영 중, 주황은 곧 마감. 목록을 읽기 전에 지도만 봐도 갈
                곳이 보여요. 핀을 누르면 바로 상세로.
              </p>
            </article>
            ...
            >
              ...
              >
                <div className="flex gap-[7px]">
                  <span
                    className="chip on rounded-full border border-[#E4EDF1] bg-white px-[13px] py-[6px] text-[12.5px] font-bold text-[#5E7C88]"
                    id="chipNight"
                  >
                    심야 운영
                  </span>
                  <span
                    className="chip rounded-full border border-[#E4EDF1] bg-white px-[13px] py-[6px] text-[12.5px] font-bold text-[#5E7C88]"
                    id="chip24"
                  >
                    24시간
                  </span>
                ...
                <div
                  className="mini-row flex items-center gap-2 rounded-[11px] border border-[#E4EDF1] bg-white px-3 py-2 text-[12.5px] font-bold tracking-[-.2px]"
                  data-tag="night24"
                >
                  비무브약국24 <Badge status="open">운영 중</Badge>
                  <span className="ml-auto text-[12px] font-extrabold text-[#086B82] tabular-nums">
                    1.2km
                  </span>
                </div>
                <div
              ...
              <p className="text-[14.5px] leading-[1.65] text-[#5E7C88]">
                밤 10시가 넘었다면 심야 운영 약국만 남기세요. 탭 한 번이면 지금
                갈 수 없는 곳이 목록에서 사라져요.
              </p>
            </article>
            ...
            >
              ...
              >
                ...
                <span className="fav-toast" id="favToast">
                  즐겨찾기에 저장됨
                </span>
              </div>
              <div
              ...
              <p className="text-[14.5px] leading-[1.65] text-[#5E7C88]">
                자주 가는 약국을 저장해두면 다음 급한 순간엔 검색 없이 바로.
                즐겨찾기 탭에서 운영 여부만 확인하면 끝.
              </p>
            </article>
            ...
            >
              <div
                className="f-stage stage-route relative mb-1 h-[172px] overflow-hidden rounded-xl bg-[#0C2A33]"
                data-stage="route"
              >
                <svg
                  className="absolute top-[-20%] left-[-20%] h-[140%] w-[140%]"
                ...
                >
                  <path
                    className="route-path route-len"
                    style={{ "--len": 520 } as CSSVars}
                    d="M85 205 H195 V130 H320 V72 H395"
                  />
                </svg>
                <span
                  className="me"
                  style={{ left: "17%", top: "79%", width: 12, height: 12 }}
                />
                <MiniPin tone="g" left="79%" top="28%" pd=".1s" />
                <span
                  className="walk-label tabular-nums"
              ...
              <p className="text-[14.5px] leading-[1.65] text-[#5E7C88]">
                카드에서 바로 전화를 걸거나 카카오맵 도보 길안내로 이어져요.
                앱을 오가며 주소를 복사할 필요가 없어요.
              </p>
            </article>
          </div>
        </div>
          ...
          <div className="grid gap-2 min-[880px]:grid-cols-[1fr_420px] min-[880px]:items-start min-[880px]:gap-[70px]">
              ...
              >
                <div className="relative h-full w-full overflow-hidden rounded-[32px] bg-[#0C2A33]">
                  <div className="absolute inset-0" aria-hidden="true">
                    <svg
                      className="absolute top-[-30%] left-[-40%] h-[160%] w-[180%]"
                      viewBox="0 0 500 700"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                  ...
                  <div className="p-chip absolute top-14 left-1/2 z-20 flex -translate-x-1/2 items-center gap-[6px] whitespace-nowrap rounded-full border border-[rgba(34,211,238,.3)] bg-[rgba(14,42,51,.85)] px-[13px] py-[7px] text-[11.5px] font-bold text-[#dff3f8]">
                    ...
                    <b data-alt="" className="tabular-nums">
                      지금 운영 중 12곳
                    </b>
                  </div>
                  ...
                  >
                    <path
                      style={{ "--len": 430 } as CSSVars}
                      d="M155 218 V300 H92 V385 H60"
                    />
                  </svg>

                  <div
                    className="p-pins absolute inset-0 z-[6]"
                    aria-hidden="true"
                  >
                  ...
                  <div className="p-sheet absolute inset-x-0 bottom-0 z-10 rounded-t-[26px] bg-white px-[14px] pt-[10px] pb-4 shadow-[0_-18px_40px_-18px_rgba(8,40,50,.45)]">
                    <div
                      className="mx-auto mt-[2px] mb-[10px] h-1 w-11 rounded-full bg-[#d6e2e8]"
                      aria-hidden="true"
                    />
                    <h4 className="mb-[9px] text-[13.5px] font-extrabold tracking-[-.3px]">
                      주변 운영 중 약국{" "}
                      <b className="text-[#0B8FAC] tabular-nums">12곳</b>
                    </h4>
                    <div className="p-card first mb-2 rounded-[13px] border border-[#E4EDF1] px-3 py-[10px] last:mb-0">
                      <div className="flex items-center gap-[7px]">
                        <span className="text-[13.5px] font-extrabold tracking-[-.3px]">
                          홈타운약국
                        </span>
                        <Badge status="open">운영 중</Badge>
                      </div>
                      <div className="mt-[3px] flex items-center justify-between">
                        <span className="text-[11.5px] font-semibold text-[#3a5560]">
                          밤 12시까지
                        </span>
                        <span className="text-[13.5px] font-extrabold text-[#086B82] tabular-nums">
                          <span data-count="320">0</span>m
                          <small className="ml-1 text-[10px] font-semibold text-[#9fb3bc]">
                            도보 5분
                          </small>
                        </span>
                      </div>
            ...
            <div className="min-[880px]:order-1 min-[880px]:pt-[8vh]">
              ...
              >
                ...
                <h3 className="mt-[13px] mb-2 text-[26px] font-extrabold tracking-[-.6px]">
                  위치 허용
                </h3>
                <p className="max-w-[26em] text-[16.5px] leading-[1.75] text-[#5E7C88]">
                  열자마자 현재 위치를 잡고 주변을 스캔해요. 회원가입도, 설치도
                  없어요. 위치를 켜기 어려우면 동네 이름으로도 찾을 수 있어요.
                </p>
              </div>
              <div
                className="step mb-1 py-4 min-[880px]:mb-0 min-[880px]:flex min-[880px]:min-h-[52vh] min-[880px]:flex-col min-[880px]:justify-center min-[880px]:py-0"
              ...
              >
                ...
                <p className="max-w-[26em] text-[16.5px] leading-[1.75] text-[#5E7C88]">
                  영업이 끝난 약국은 뒤로 보내고, 지금 갈 수 있는 곳부터
                  거리순으로 정렬해요. 곧 마감인 곳은 미리 알려드려요.
                </p>
              </div>
              <div
                className="step mb-1 py-4 min-[880px]:mb-0 min-[880px]:flex min-[880px]:min-h-[52vh] min-[880px]:flex-col min-[880px]:justify-center min-[880px]:py-0"
              ...
              >
                ...
                <p className="max-w-[26em] text-[16.5px] leading-[1.75] text-[#5E7C88]">
                  가까운 약국을 고르면 경로가 그려지고, 전화와 카카오맵 도보
                  안내가 버튼 하나로 이어져요.
                </p>
              </div>
            </div>
      ...
      <section className="border-t border-[#E4EDF1] bg-white py-24" id="trust">
        <div
          className={`${WRAP} grid gap-11 min-[1080px]:grid-cols-[1.1fr_.9fr] min-[1080px]:items-center min-[1080px]:gap-[72px]`}
        >
          <div>
            <span className={EYEBROW} data-reveal>
              믿을 수 있는 데이터
            ...
            <p
              className="max-w-[30em] text-[16px] text-[#5E7C88]"
              data-reveal
              style={{ "--d": ".16s" } as CSSVars}
            >
              전국 약국의 운영시간 정보는 공공데이터포털의 약국 정보 API를
              기반으로 하며, 매일 자동으로 갱신돼요. 광고나 제휴 순위 없이 오직
              거리와 운영 여부로만 정렬합니다.
            </p>
            <div
            ...
            >
              <svg
                className="mt-[2px] flex-none text-[#EA9006]"
                width="17"
                height="17"
                viewBox="0 0 24 24"
                fill="none"
              ...
              <span>
                실제 운영시간은 사정에 따라 다를 수 있어요. 늦은 시간엔 방문 전
                전화 확인을 권장하며, 약 복용 상담은 반드시 약사와 하세요.
              </span>
            </div>
          </div>
          <div
          ...
          >
            <div className="t-stat rounded-[15px] bg-[#E8EFF2] px-3 py-[22px] text-center">
              <div className="text-[clamp(19px,3.6vw,26px)] font-extrabold tracking-[-.03em] text-[#086B82] tabular-nums">
                ...
                <small className="ml-[1px] text-[.55em] font-extrabold">
                  +
                </small>
              </div>
              <div className="mt-[5px] text-[12.5px] font-bold text-[#5E7C88]">
                전국 약국 정보
              </div>
            </div>
            <div className="t-stat rounded-[15px] bg-[#E8EFF2] px-3 py-[22px] text-center">
      ...
      {/* ================================================================ CTA */}
      <section
        className="cta relative overflow-hidden bg-[#0C2A33] pt-[120px] pb-[130px] text-center text-white"
        id="cta"
      >
        <span className="ring" aria-hidden="true" />
        <span className="ring" aria-hidden="true" />
        ...
        <div className={WRAP}>
          <h2
            className="relative text-[clamp(28px,5vw,46px)] font-extrabold leading-[1.3] tracking-[-.045em] text-balance"
            data-reveal
          >
            다음 급한 밤엔,
            <br />
          ...
          <p
            className="relative mt-4 mb-8 text-[16.5px] text-[rgba(216,236,241,.75)]"
            data-reveal
            style={{ "--d": ".1s" } as CSSVars}
          >
            설치 없이 웹에서 바로 열려요. 지금 한 번 써보고, 즐겨찾기만
            눌러두세요.
          </p>
          <div data-reveal style={{ "--d": ".2s" } as CSSVars}>
            <Link
              className={`${BTN} ${BTN_PRIMARY} relative px-[34px] py-[18px] text-[17px]`}
              href="/map"
            >
              <svg
                width="18"
            ...
            <div className="relative mt-4 text-[12.5px] font-semibold text-[rgba(255,255,255,.45)]">
              무료 · 회원가입 없음
            </div>
          </div>
        </div>
      ...
      <footer className="bg-[#081c23] pt-[34px] pb-11 text-[12.5px] text-[rgba(255,255,255,.55)]">
        <div className={WRAP}>
          ...
          <p className="mt-3 max-w-[56em] leading-[1.7]">
            본 서비스는 공공데이터포털 약국 정보를 기반으로 하며, 의료 행위 또는
            약사 상담을 대체하지 않습니다. 표시된 운영시간은 실제와 다를 수
            있으니 방문 전 전화로 확인해 주세요.
          </p>
        </div>
      </footer>
    </div>
